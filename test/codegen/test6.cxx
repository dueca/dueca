...
int main()
{
  ...
  assert (o1 == o1r);
  assert (o2 == o2r);
  Object6 o3r(o2); cout << "o3r"<< endl;
  unPackDataDiff(re, o3r);
  Object6 o3s(re); cout << "o3s" << endl;
  assert(o3 == o3r);
  assert(o3 == o3s);
  Object6 o4r(o2); cout << "o4r" << endl;
  unPackDataDiff(re, o4r);
  assert(o4 == o4r);
  Object6 o5r(o1); cout << "o5r" << endl;
  unPackDataDiff(re, o5r);
  assert(o5 == o5r);
  Object6 o6r(o1); cout << "o6r" << endl;
